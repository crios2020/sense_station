...
/*
 *  Diseño del Buffer serial Arduino a Java version 2 Adaptado para DHT 22
 *  
 *  v1  v2  v3  v4  v5  v6  v7  v8  v9  v10
 *  
 *  v1: versión del buffer, rango 1 - 100, La idea es que el receptor del buffer pueda identificar la versión correctamente.
 *  
 *  v2: medición de temperatura, rango -40 - +125, para el sensor DHT-22 en grados centigrados
 * 
 *  v3: medición de humedad, rango 0 - 100, para el sensor DHT-22 en %
 *  
